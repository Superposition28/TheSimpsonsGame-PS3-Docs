...
# Optional environment variable override. If empty/missing or not found, lookups are skipped.
SQLITE_DB_PATH = os.environ.get("SIMPGAME_TEXTURE_INDEX_DB", r"")
SQLITE_TABLE = os.environ.get("SIMPGAME_TEXTURE_INDEX_TABLE", "dds_index")
